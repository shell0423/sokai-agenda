...
""")
    ...
    with st.expander("🏷️ Tier と 区分・条件の意味"):
        st.markdown("""
**Tier（張れそうな強さ）** — 保有比率 × 買い増し × 否決/継続の強度で自動分類
- 🟦 **A 最優先** … 保有10%超、または買い増し中×否決/継続
- 🟪 **B 要注目** … 保有5%以上の買い増し・継続
- ⬜ **C ウォッチ** … 初期段階・大口だが動意待ち
